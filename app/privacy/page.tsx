    ...
    <>
      ...
      <Content>
        <p className="my-4 text-sm text-muted-foreground">
          Your privacy is important to us. It is Fake News Detector&rsquo;s
          policy to respect your privacy regarding any information we may
          collect from you across our website,{" "}
          <a href="ai-fake-news-ro.vercel.app">ai-fake-news-ro.vercel.app</a>,
        ...
        <p className="my-4 text-sm text-muted-foreground">
          This policy is effective as of 1 September 2021.
        </p>
      </Content>
    </>
  );
