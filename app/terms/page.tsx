...
const Terms = () => {
  return (
    <>
      ...
      <Content>
        <div className="prose prose-sm mx-auto my-8 p-6 shadow-md rounded-lg">
          <p className="lead text-xl font-semibold mb-4">
            Welcome to Fake News Detector.
          </p>
          <p className="mb-4">
            These terms and conditions outline the rules and regulations for the
            use of Fake News Detector&apos;s Website, located at
            ai-fake-news-ro.vercel.app.
          </p>
          <p className="mb-4">
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use Fake News Detector if you do not
          ...
          <p className="mb-4">
            We employ the use of cookies. By accessing Fake News Detector, you
            agreed to use cookies in agreement with the Fake News
            Detector&apos;s Privacy Policy.
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            Unless otherwise stated, Fake News Detector and/or its licensors own
            the intellectual property rights for all material on Fake News
            Detector. All intellectual property rights are reserved. You may
            access this from Fake News Detector for your own personal use
            subjected to restrictions set in these terms and conditions.
          </p>
          <p className="mb-4">You must not:</p>
          <ul className="list-disc list-inside mb-4">
            <li>Republish material from Fake News Detector</li>
            <li>Sell, rent or sub-license material from Fake News Detector</li>
            <li>
              Reproduce, duplicate or copy material from Fake News Detector
            </li>
            <li>Redistribute content from Fake News Detector</li>
          </ul>
          <p className="mb-4">This Agreement shall begin on the date hereof.</p>
          <p className="mb-4">
            Parts of this website offer an opportunity for users to post and
            exchange opinions and information in certain areas of the website.
            Fake News Detector does not filter, edit, publish or review Comments
            prior to their presence on the website. Comments do not reflect the
            views and opinions of Fake News Detector, its agents and/or
            ...
            applicable laws, Fake News Detector shall not be liable for the
          ...
          <p className="mb-4">
            Fake News Detector reserves the right to monitor all Comments and to
          ...
          <p className="mb-4">
            You hereby grant Fake News Detector a non-exclusive license to use,
          ...
          <p className="mb-4">
            ...
            visibility of the hyperlink compensates the absence of Fake News
            Detector; and (d) the link is in the context of general resource
            information.
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            sending an e-mail to Fake News Detector. Please include your name,
          ...
          <p className="mb-4">
            No use of Fake News Detector&apos;s logo or other artwork will be
